...
core'da tek satır değişmez. Bugün gönderilen tek adaptör `@originloom/react`'tir. Framework'süz bir
adaptör (`html` tagged template + düz TypeScript island'lar) daha önce ayrı bir paket olarak
gönderildi ve 0.7.0'da kaldırıldı: kontratı doğruluyordu ama kullanıcısı yoktu, ve her template
değişikliğinin iki kez yazılmasını gerektiriyordu.
