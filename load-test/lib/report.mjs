 ...
 */
export async function writeReport({ outputDir, profile, suite, meta, results, metricsBefore, metricsAfter }) {
  ...
  await writeFile(path.join(outputDir, "results.json"), `${JSON.stringify(payload, null, 2)}\n`, "utf8");
