...
## Ölçüm: aynı sayfada Next.js App Router ile OriginLoom
...
|                | OriginLoom `:3005` | Next.js POC `:3006` |
| -------------- | --------------- | ------------------- |
| RPS (ort.)     | ~1.972          | ~20                 |
| Gecikme (ort.) | ~25 ms          | ~2.227 ms           |

Bu tablo “Next.js kötü” demek değildir. OriginLoom tarafında route **shared HTML cache HIT** ağırlıklı
...
[06 — Aynı Sayfada Next.js ve OriginLoom: Blog Paginated Yük Testi](./06-ayni-sayfada-nextjs-ve-origin-loom-yuk-testi.md).
